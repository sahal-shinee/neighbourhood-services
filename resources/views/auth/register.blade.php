...
<div x-data="{ 
    ...
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-5">
        ...
        <!-- Alamat with Inline SVG Icon (Animated Step 7) -->
        <div class="animate-fade-in-up delay-350">
            ...
            <div class="relative flex items-start group">
                <span class="absolute left-4 top-3.5 text-gray-400 group-focus-within:text-brand-600 group-focus-within:scale-110 pointer-events-none select-none transition-all duration-300">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                </span>
                <textarea id="alamat" name="alamat" required rows="2" 
                    placeholder="Tulis alamat lengkap pengerjaan jasa..."
                    class="block w-full bg-gray-55 border border-gray-200 text-gray-900 rounded-2xl pl-12 pr-4 py-3.5 focus:bg-white focus:border-brand-500 premium-input-field outline-none sm:text-base font-medium resize-none"></textarea>
            </div>
            @error('alamat') <p class="text-sm text-red-500 mt-1.5 font-medium">{{ $message }}</p> @enderror
        </div>
