                            ...
                            @if($penyedia->foto_ktp)
                                ...
                                <x-modal name="ktp-{{ $penyedia->id_pengguna }}" maxWidth="2xl">
                                    <div class="p-6">
                                        ...
                                        <div class="bg-gray-100 rounded-2xl overflow-hidden flex items-center justify-center p-3 min-h-[160px]"
                                             x-data="{ broken: false }">
                                            <img src="{{ route('admin.pengguna.ktp', $penyedia->id_pengguna) }}"
                                                 alt="KTP {{ $penyedia->nama_lengkap }}"
                                                 class="max-w-full h-auto max-h-[60vh] object-contain rounded-lg"
                                                 x-show="!broken"
                                                 x-on:error="broken = true">
                                            <div x-show="broken" x-cloak class="flex flex-col items-center gap-3 py-8 text-gray-400">
                                                <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                                </svg>
                                                <p class="text-sm font-semibold text-gray-500">File foto KTP tidak ditemukan di server.</p>
                                                <p class="text-xs text-gray-400">Penyedia mungkin perlu mendaftar ulang untuk mengunggah KTP baru.</p>
                                            </div>
                                        </div>
